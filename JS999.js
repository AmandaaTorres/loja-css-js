(function () {
    const banners = [
        {
            src: "https://cdn.ereemby.com/attachments/17444144944505708imagem.png",
            link: "https://lojaarcane.com.br/product/17389668689970666485695287131"
        },
        {
            src: "https://cdn.ereemby.com/attachments/17444145430117312imagem.png",
            link: "https://lojaarcane.com.br/product/17389608690012503457964551860"
        },
        {
            src: "https://cdn.ereemby.com/attachments/17442635564237129imagem.png",
            link: "https://lojaarcane.com.br/product/1744128946180785124858786569645727"
        },
        {
            src: "https://cdn.ereemby.com/attachments/17448579011301096imagem.png",
            link: "https://lojaarcane.com.br/product/17448226691074273242380634247342"
        }
    ];
    ...
    function criarBannerBoaPlay(elemento) {
      ...
      <div class="boaplay-hero-left">
        <h1>Esqueça limitações. <span class="rgb-wave-text">Domine</span><br>e vença com a Dominante Cheats.</h1>
        <p>Junte-se ao nosso servidor no Discord,
        Anunciamos estoques e cupons diariamente! Entre agora e fique por dentro de todas as novidades.</p>
        <div class="boaplay-buttons">
          <button class="btn-blue" onclick="window.location.href='/category'">Ver Produtos</button>
          <button class="btn-dark" onclick="window.open('https://discord.gg/lojaarcane', '_blank')">Junte-se a nós</button>
        </div>
      </div>
    ...
    (function () {
        ...
        function shouldHaveSmoothScroll() {
            return window.location.origin === 'https://teste999.erb.digital' && window.location.pathname === '/';
        }
...
(function () {
    const features = [
        {
            ...
            title: 'Segurança',
            desc: 'Na Loja Arcane, sua segurança vem primeiro. Aqui Protegemos seus dados e oferecemos suporte 24/7.'
        },
        {
            icon: 'https://cdn.ereemby.com/attachments/17489269819793200imagem.png',
            title: 'O Melhor Custo Benefício',
            desc: 'Nossos proddutos Tem os Melhores Preços do Mercado Brasileiro.'
        },
        {
            icon: 'https://cdn.ereemby.com/attachments/17489951353192240imagem.png',
            title: 'Pague com segurança',
            desc: 'Pagamentos com foco total na sua segurança.'
        },
        {
    ...
    function checkAndInsert() {
        const target = document.querySelector('.sc-2f91eb97-1.gWPGWF');
...
function createSidebar() {
    ...
    sidebar.innerHTML = `
    <a class="sidebar-icon" href="https://discord.gg/lojaarcane" target="_blank">
      <img src="https://cdn.ereemby.com/attachments/17490362106163243imagem.png" alt="Home" />
    </a>
    <a class="sidebar-icon" href="https://dominante.erb.digital/terms" target="_blank">
...
function injectGlassContent() {
    ...
    if (gridContainer && !document.querySelector('.glass-wrapper')) {
        ...
        glassText.innerHTML = `
            <div class="glass-main-text">A Loja Acane Oferece:</div>
